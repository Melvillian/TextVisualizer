...
public class ParseTree {
     ...
     *
     * @return a list of the children parse trees
     */
    ...
    /**
     * Get the number of terminal nodes beneath the current parse tree
     * @return
     */
    public int getTerminalNum() {
        if (this.isTerminal()) return 1;
            ...
            int sum = 0;
            for (ParseTree tree : this.getChildren()) {
                sum += tree.getTerminalNum();
            }
            return sum;
        }
    }
